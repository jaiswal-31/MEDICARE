...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      name: "LinkedIn",
      href: "https://www.linkedin.com/in/shashank-jaiswal-27150b363",
    },
    {
      Icon: Youtube,
          ...
          <div className={footerStyles.companySection}>
            ...
            <div className={footerStyles.contactContainer}>
              <div className={footerStyles.contactItem}>
                ...
                <span className={footerStyles.contactText}>+91 1234567890</span>
              </div>
              <div className={footerStyles.contactItem}>
                <div className={footerStyles.contactIconWrapper}>
              ...
              <div className={footerStyles.contactItem}>
                ...
                <span className={footerStyles.contactText}>Patna, India</span>
              </div>
            </div>
          </div>
